    ...
    <form x-ref="filterForm" action="<?php echo e(route('admin.penalties')); ?>" method="GET">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
            <div>
                ...
                <input type="text" name="search" x-model="filters.search" placeholder="<?php echo e(__('admin.penalties.search_placeholder')); ?>"
            ...
            <div>
                ...
                <select name="status" x-model="filters.status"
                    ...
                    <option value="active"><?php echo e(__('admin.penalties.status.active')); ?></option>
                    <option value="under_review"><?php echo e(__('admin.penalties.status.under_review')); ?></option>
                    <option value="resolved"><?php echo e(__('admin.penalties.status.resolved')); ?></option>
                    <option value="dismissed"><?php echo e(__('admin.penalties.status.dismissed')); ?></option>
                </select>
            </div>
            <div>
                <label class="text-sm font-medium text-neutral-text dark:text-neutral-text-dark mb-2 block">
                    <?php echo e(__('admin.penalties.filter_severity')); ?>

                </label>
                <select name="severity" x-model="filters.severity"
                    class="w-full px-4 py-2 rounded-lg bg-background-light dark:bg-background-dark border border-border-light dark:border-border-dark text-body-text dark:text-body-text-dark focus:outline-none focus:ring-2 focus:ring-primary">
                    <option value=""><?php echo e(__('common.filters.all')); ?></option>
                    <option value="low"><?php echo e(__('admin.penalties.severity.low')); ?></option>
                    <option value="medium"><?php echo e(__('admin.penalties.severity.medium')); ?></option>
                    <option value="high"><?php echo e(__('admin.penalties.severity.high')); ?></option>
                    <option value="critical"><?php echo e(__('admin.penalties.severity.critical')); ?></option>
                </select>
            </div>
            <div>
                <label class="text-sm font-medium text-neutral-text dark:text-neutral-text-dark mb-2 block">
                    <?php echo e(__('admin.penalties.filter_pharmacy')); ?>
        ...
        <table class="w-full">
            <thead class="bg-background-light dark:bg-background-dark">
                <tr>
                    ...
                    <th
                        class="px-6 py-3 text-left text-xs font-medium text-neutral-text dark:text-neutral-text-dark uppercase tracking-wider">
                        <?php echo e(__('admin.penalties.table.pharmacy')); ?>
                    ...
                    <th
                        class="px-6 py-3 text-left text-xs font-medium text-neutral-text dark:text-neutral-text-dark uppercase tracking-wider">
                        <?php echo e(__('admin.penalties.table.severity')); ?>
                    ...
                    <th
                        class="px-6 py-3 text-left text-xs font-medium text-neutral-text dark:text-neutral-text-dark uppercase tracking-wider">
                        <?php echo e(__('admin.penalties.table.issued')); ?>
                    ...
                    <tr class="hover:bg-background-light dark:hover:bg-background-dark transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-primary">
                                #PEN-<?php echo e(str_pad($i, 4, '0', STR_PAD_LEFT)); ?>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="text-xs text-neutral-text dark:text-neutral-text-dark">
                                        <?php echo e(__('admin.penalties.branch_number', ['number' => $i])); ?>
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm text-body-text dark:text-body-text-dark max-w-xs">
                                <?php echo e($reasons[($i - 1) % count($reasons)]); ?>

                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span
                                class="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e($severityColors[$severities[$severityIndex]]); ?>">
                                <?php echo e(__('admin.penalties.severity.' . $severities[$severityIndex])); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span
                                ...
                                <?php echo e(__('admin.penalties.status.' . $statuses[$statusIndex])); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-body-text dark:text-body-text-dark">
                                <?php echo e(now()->subDays($i * 2)->format('M d, Y')); ?>

                            </div>
                            <div class="text-xs text-neutral-text dark:text-neutral-text-dark">
                                <?php echo e(now()->subDays($i * 2)->format('H:i')); ?>

                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <button
                                class="text-primary hover:text-primary/80 mr-3"><?php echo e(__('common.actions.view')); ?></button>
                            <button
                                class="text-warning hover:text-warning/80"><?php echo e(__('common.actions.review')); ?></button>
                        </td>
                    </tr>
                <?php endfor; ?>
            </tbody>
    ...
    <div class="px-6 py-4 border-t border-border-light dark:border-border-dark">
        <div class="flex items-center justify-between">
            <div class="text-sm text-neutral-text dark:text-neutral-text-dark">
                ...
                <?php echo e(__('common.pagination.to')); ?> <span class="font-medium">12</span>
                <?php echo e(__('common.pagination.of')); ?> <span class="font-medium">48</span>
...
<?php /**PATH C:\xampp\htdocs\laravel\securityAccess\security-access\resources\views/admin/partials/penalties-content.blade.php ENDPATH**/ ?>